import{ac as se,p as b,n as E,Z as bt,ad as $e,X as K,g as de,ae as St,r as T,af as wt,T as ve,ag as _t,y as kt,c as g,e as k,q as u,C as Ne,V as Re,s as V,w as W,P as Ct,R as Tt,a0 as re,a8 as ze,Q as q,a1 as xt,W as z,ah as O,ai as Oe,aj as _e,ak as Pt,al as Vt,f as At,b as Et,L as ke,$ as U,t as me,v as ge,am as It,u as De,an as Bt,ao as Lt,ap as $t,aq as Ce,ar as Nt,as as Te,i as Y,h as X,at as B,j as Rt,o as Me,A as xe,au as Pe,av as zt}from"./index-9b4cd3c7.js";const Ot=["top","bottom"],Dt=["start","end","left","right"];function Pn(e,a){let[n,t]=e.split(" ");return t||(t=se(Ot,n)?"start":se(Dt,n)?"top":"center"),{side:Ve(n,a),align:Ve(t,a)}}function Ve(e,a){return e==="start"?a?"right":"left":e==="end"?a?"left":"right":e}const L=b({class:[String,Array],style:{type:[String,Array,Object],default:null}},"component");function He(e){let a=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"div",n=arguments.length>2?arguments[2]:void 0;return E()({name:n??bt($e(e.replace(/__/g,"-"))),props:{tag:{type:String,default:a},...L()},setup(t,s){let{slots:i}=s;return()=>{var r;return K(t.tag,{class:[e,t.class],style:t.style},(r=i.default)==null?void 0:r.call(i))}}})}function D(e){const a=de("useRender");a.render=e}const Vn=[{title:"admin.sc-voice.net",summary:"Voice administration website",link:"https://admin.sc-voice.net",github:"sc-voice/admin_sc-voice_net",admin:!0,text:`
    (This server)
  ...
  `},{title:"legacy.sc-voice.net",summary:"Legacy Voice website",link:"https://voice.suttacentral.net",api:"voice.suttacentral.net",voice:"(deprecated)",text:`
    This is the redirecting service to the new sc-voice.net
  `,github:"sc-voice/TDE"},{title:"voice.suttacentral.net",summary:"Legacy Voice website",link:"https://voice.suttacentral.net",api:"voice.suttacentral.net",voice:"(deprecated)",text:`
