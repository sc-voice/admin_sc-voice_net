import{ac as se,p as b,n as V,Z as bt,ad as Ne,X as Y,g as de,ae as St,r as T,af as wt,T as ve,ag as _t,y as kt,c as h,e as k,q as u,C as Re,V as $e,s as E,w as F,P as Ct,R as Tt,a0 as re,a8 as ze,Q as q,a1 as xt,W as z,ah as D,ai as De,aj as _e,ak as At,al as Et,f as Pt,b as Vt,L as ke,$ as U,t as me,v as he,am as It,u as Oe,an as Lt,ao as Bt,ap as Nt,aq as Ce,ar as Rt,as as Te,i as K,h as X,at as L,j as $t,o as Ge,A as xe,au as Ae,av as zt}from"./index-da7d30da.js";const Dt=["top","bottom"],Ot=["start","end","left","right"];function An(e,a){let[n,t]=e.split(" ");return t||(t=se(Dt,n)?"start":se(Ot,n)?"top":"center"),{side:Ee(n,a),align:Ee(t,a)}}function Ee(e,a){return e==="start"?a?"right":"left":e==="end"?a?"left":"right":e}const B=b({class:[String,Array],style:{type:[String,Array,Object],default:null}},"component");function He(e){let a=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"div",n=arguments.length>2?arguments[2]:void 0;return V()({name:n??bt(Ne(e.replace(/__/g,"-"))),props:{tag:{type:String,default:a},...B()},setup(t,s){let{slots:i}=s;return()=>{var r;return Y(t.tag,{class:[e,t.class],style:t.style},(r=i.default)==null?void 0:r.call(i))}}})}function O(e){const a=de("useRender");a.render=e}const En=[{title:"admin.sc-voice.net",summary:"Voice administration website",link:"https://admin.sc-voice.net",github:"sc-voice/admin_sc-voice_net",admin:!0,text:`
    (This server)
  ...
  `},{title:"sc-voice-legacy",summary:"URL resolver for legacy voice.suttacentral.net",link:"https://legacy-voice.suttacentral.net",github:"sc-voice-legacy/voice_suttacentral_net",api:"voice.suttacentral.net",voice:"(redirection)",text:`
