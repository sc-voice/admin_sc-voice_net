import{ac as se,p as b,n as I,Z as bt,ad as $e,X as K,g as de,ae as St,r as x,af as wt,T as ve,ag as _t,y as kt,c as g,e as k,q as u,C as Ne,V as Re,s as A,w as F,P as Ct,R as xt,a0 as re,a8 as ze,Q as q,a1 as Tt,W as z,ah as O,ai as Oe,aj as _e,ak as Pt,al as At,f as Vt,b as It,L as ke,$ as U,t as me,v as ge,am as Et,u as De,an as Lt,ao as Bt,ap as $t,aq as Ce,ar as Nt,as as xe,i as X,h as Y,at as L,j as Rt,o as Me,A as Te,au as Pe,av as zt}from"./index-45a3d91c.js";const Ot=["top","bottom"],Dt=["start","end","left","right"];function Pn(e,a){let[n,t]=e.split(" ");return t||(t=se(Ot,n)?"start":se(Dt,n)?"top":"center"),{side:Ae(n,a),align:Ae(t,a)}}function Ae(e,a){return e==="start"?a?"right":"left":e==="end"?a?"left":"right":e}const B=b({class:[String,Array],style:{type:[String,Array,Object],default:null}},"component");function He(e){let a=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"div",n=arguments.length>2?arguments[2]:void 0;return I()({name:n??bt($e(e.replace(/__/g,"-"))),props:{tag:{type:String,default:a},...B()},setup(t,s){let{slots:i}=s;return()=>{var r;return K(t.tag,{class:[e,t.class],style:t.style},(r=i.default)==null?void 0:r.call(i))}}})}function D(e){const a=de("useRender");a.render=e}const An=[{title:"admin.sc-voice.net",summary:"Voice administration website",link:"https://admin.sc-voice.net",github:"sc-voice/admin_sc-voice_net",admin:!0,text:`
    (This server)
  ...
  `,link:"https://ebt-site.sc-voice.net",github:"sc-voice/ebt-site3"},{title:"Linode Server",summary:"Voice API server hardware",link:"https://github.com/sc-voice/api_sc-voice_net/wiki/Linode-Server-Setup",admin:!0,api:"api.sc-voice.net",text:`
  ...
  `},{title:"sc-voice/ebt-vue3",summary:"EBT-Site application library",voice:"EBT-Site",link:"https://ebt-vue3.sc-voice.net",github:"sc-voice/ebt-vue3",library:"npm install ebt-vue3",text:`
  ...
  `,github:"pannabijani/site-tba"},{title:"pli.api.sc-voice.net",summary:"Pali (pli) Voice API server",link:"https://pli.api.sc-voice.net/status",github:"sc-voice/api_sc-voice_net",api:"api.sc-voice.net",admin:!0,monitor:"https://pli.api.sc-voice.net/scv/probes",text:`
    ...
    API servers.
  `},{title:"s1.sc-voice.net",summary:"prototype Voice API server",link:"https://s1.sc-voice.net",api:"voice.suttacentral.net",github:"sc-voice/scv-server",text:`
    (deprecated)
