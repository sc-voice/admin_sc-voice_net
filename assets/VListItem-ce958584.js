import{ac as se,p as b,n as P,Z as bt,ad as Ne,X as Y,g as de,ae as St,r as T,af as wt,T as ve,ag as _t,y as kt,c as h,e as k,q as u,C as Re,V as $e,s as A,w as F,P as Ct,R as Tt,a0 as re,a8 as ze,Q as q,a1 as xt,W as z,ah as O,ai as Oe,aj as _e,ak as Vt,al as At,f as Et,b as Pt,L as ke,$ as U,t as me,v as he,am as It,u as De,an as Bt,ao as Lt,ap as Nt,aq as Ce,ar as Rt,as as Te,i as K,h as X,at as B,j as $t,o as Ge,A as xe,au as Ve,av as zt}from"./index-d0419f6a.js";const Ot=["top","bottom"],Dt=["start","end","left","right"];function Vn(e,a){let[n,t]=e.split(" ");return t||(t=se(Ot,n)?"start":se(Dt,n)?"top":"center"),{side:Ae(n,a),align:Ae(t,a)}}function Ae(e,a){return e==="start"?a?"right":"left":e==="end"?a?"left":"right":e}const L=b({class:[String,Array],style:{type:[String,Array,Object],default:null}},"component");function He(e){let a=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"div",n=arguments.length>2?arguments[2]:void 0;return P()({name:n??bt(Ne(e.replace(/__/g,"-"))),props:{tag:{type:String,default:a},...L()},setup(t,s){let{slots:i}=s;return()=>{var r;return Y(t.tag,{class:[e,t.class],style:t.style},(r=i.default)==null?void 0:r.call(i))}}})}function D(e){const a=de("useRender");a.render=e}const An=[{title:"admin.sc-voice.net",summary:"Voice administration website",link:"https://admin.sc-voice.net",github:"sc-voice/admin_sc-voice_net",admin:!0,text:`
    (This server)
  ...
  `},{title:"scripts/update-vuetify",summary:"script to update the Vue/Vuetify UI framework",link:"https://voice.suttacentral.net",admin:!0,text:`
  ...
  `,github:"sc-voice/ebt-vue3"},{title:"voice.suttacentral.net",summary:"Legacy Voice website",link:"https://voice.suttacentral.net",api:"voice.suttacentral.net",voice:"(deprecated)",text:`
